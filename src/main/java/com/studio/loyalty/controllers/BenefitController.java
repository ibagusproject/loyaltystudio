...
public class BenefitController {
    ...
    @PostMapping
    public ResponseEntity<Object> create(@RequestBody @Valid BenefitDto benefit) {
        try {
    ...
    @PutMapping
    public ResponseEntity<Object> update(@RequestBody @Valid BenefitDto benefit) {
        try {
    ...
    @DeleteMapping
    public ResponseEntity<Object> delete(@RequestBody @Valid BenefitEntity benefit) {
        try {
