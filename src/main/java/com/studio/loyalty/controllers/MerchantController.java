...
public class MerchantController {
    ...
    @PostMapping
    public ResponseEntity<Object> create(@RequestBody @Valid MerchantDto merchant) {
        try {
    ...
    @PutMapping
    public ResponseEntity<Object> update(@RequestBody @Valid MerchantDto merchant) {
        try {
    ...
    @DeleteMapping
    public ResponseEntity<Object> delete(@RequestBody @Valid MerchantEntity merchant) {
        try {
