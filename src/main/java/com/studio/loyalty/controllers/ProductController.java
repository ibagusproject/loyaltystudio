...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<Object> create(@RequestBody @Valid ProductDto product) {
        try {
    ...
    @PutMapping
    public ResponseEntity<Object> update(@RequestBody @Valid ProductDto product) {
        try {
    ...
    @DeleteMapping
    public ResponseEntity<Object> delete(@RequestBody @Valid ProductEntity product) {
        try {
