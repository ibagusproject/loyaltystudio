...
public class RankController {
    ...
    @PostMapping
    public ResponseEntity<Object> create(@RequestBody @Valid RankDto user) {
        try {
    ...
    @PutMapping
    public ResponseEntity<Object> update(@RequestBody @Valid RankDto user) {
        try {
    ...
    @DeleteMapping
    public ResponseEntity<Object> delete(@RequestBody @Valid RankEntity user) {
        try {
