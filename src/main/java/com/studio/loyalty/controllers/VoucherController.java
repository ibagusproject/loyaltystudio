...
public class VoucherController {
    ...
    @PostMapping
    public ResponseEntity<Object> create(@RequestBody @Valid VoucherDto voucher) {
        try {
    ...
    @PutMapping
    public ResponseEntity<Object> update(@RequestBody @Valid VoucherDto voucher) {
        try {
    ...
    @DeleteMapping
    public ResponseEntity<Object> delete(@RequestBody @Valid VoucherEntity voucher) {
        try {
